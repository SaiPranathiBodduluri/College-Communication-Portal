...
import { ArrowLeft, MessageCircle, CheckCircle, Calendar, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-3">
              <div className="p-3 rounded-full bg-blue-100">
                <MessageCircle className="h-8 w-8 text-vignan-blue" />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Comments & Acknowledgments</h1>
                <p className="text-gray-600">
                  View comments and acknowledgments on notices created by {user?.name}
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Created Notices with Comments/Acknowledgments */}
        <div className="px-4 py-6 sm:px-0">
          <div className="card">
            {createdNotices.length > 0 ? (
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="text-center">
                          <div className="flex items-center space-x-1 text-blue-600">
                            ...
                            <span className="font-semibold">{notice.comments?.length || 0}</span>
                          </div>
                          <span className="text-xs text-gray-500">Comments</span>
                        </div>
                        
                        <Link
                          to={`/comment-details/${notice._id}`}
              ...
              <div className="px-6 py-12 text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Create notices to start receiving comments and acknowledgments.
                </p>
                <Link
                  to="/notices/create"
