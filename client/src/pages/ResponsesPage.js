...
import { ArrowLeft, FileText, Calendar, Paperclip } from 'lucide-react';
...
const ResponsesPage = () => {
  ...
  const getFileResponseCount = (notice) => {
    if (!notice.comments) return 0;
    return notice.comments.filter(comment => 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">File Responses</h1>
                <p className="text-gray-600">
                  View file responses submitted to notices created by {user?.name}
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Created Notices with File Responses */}
        <div className="px-4 py-6 sm:px-0">
          <div className="card">
            {createdNotices.length > 0 ? (
                      ...
                      <div className="flex items-center space-x-6">
                        <div className="text-center">
                          <div className="flex items-center space-x-1 text-green-600">
                            ...
                            <span className="font-semibold">{getFileResponseCount(notice)}</span>
                          </div>
                          <span className="text-xs text-gray-500">File Responses</span>
                        </div>
                        
                        <Link
                          to={`/response-details/${notice._id}`}
              ...
              <div className="px-6 py-12 text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Create notices with file submissions enabled to start receiving responses.
                </p>
                <Link
                  to="/notices/create"
